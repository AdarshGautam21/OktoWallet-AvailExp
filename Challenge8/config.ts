export default {
    seed: "simple street ugly young spin unique tuna myth tennis weather try exchange",
    endpoint: "wss://turing-rpc.avail.so/ws",
    appId: 0,
    amount: 100,
    recipient: "simple street ugly young spin unique tuna myth tennis weather try exchange",
    sessionKeys:
